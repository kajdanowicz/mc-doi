...
evaluated = set()
with open(directory + 'frequencies/contagion_fscore_diff', 'r', encoding='utf-8') as file:
    e = file.readlines()
...
def evaluate(path, iter_length):
    ...
    for i in range(1,min(7,33-history)+1):
        open(path + '/contagion_fscore_diff_' + str(i - 1), 'w', encoding='utf-8').close()
        ...
        for contagion_id in range(d.num_contagions):
            with open(path + '/contagion_fscore_diff_' + str(i - 1), 'a', encoding='utf-8') as file:
        ...
        with open(directory + 'frequencies/contagion_fscore_diff', 'a', encoding='utf-8') as file:
            file.write(path + '/contagion_fscore_diff_' + str(i - 1) + '\n')
