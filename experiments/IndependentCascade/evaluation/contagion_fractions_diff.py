...
evaluated = set()
with open(directory + 'frequencies/contagion_fractions_diff', 'r', encoding='utf-8') as file:
    e = file.readlines()
...
def evaluate(path, iter_length):
    ...
    for i in range(1,min(7,33-history)+1):
        ...
        with open(directory + 'frequencies/contagion_fractions_diff', 'a', encoding='utf-8') as file:
            file.write(path + '/contagion_fractions_diff_' + str(i - 1) + '\n')
