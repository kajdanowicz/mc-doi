...
evaluated = set()
with open(directory + 'frequencies/fscore', 'r', encoding='utf-8') as file:
    e = file.readlines()
...
def evaluate(path, iter_length):
    ...
    for i in range(1,min(7,33-history)+1):
        ...
        with open(directory + 'frequencies/fscore', 'a', encoding='utf-8') as file:
            file.write(path + '/fscore_' + str(i - 1) + '\n')
