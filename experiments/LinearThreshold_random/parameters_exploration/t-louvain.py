...
from model.single_contagion_models import SingleContagionLinearThresholdModel_random as LinearThresholdRandom
import numpy as np
...
directory = '/nfs/maciej/mcdoi/linear-threshold-model/'
    ...
    if flag:
        ...
        for batch_size in batch_sizes:
            if path_dataset_history+ '/' + batch_type + '/size_' + str(batch_size) not in estimated:
                ...
                new_path_dataset_history[4] = 'linear-threshold-model'
