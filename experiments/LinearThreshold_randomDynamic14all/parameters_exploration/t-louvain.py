...
from model.single_contagion_models import SingleContagionLinearThresholdModel_randomDynamic as LinearThresholdRandomDynamic
import numpy as np
...
directory = '/nfs/maciej/mcdoi/linear-threshold-random-dynamic-14all/'
            ...
            if path_dataset_history+ '/' + batch_type + '/size_' + str(batch_size) not in estimated:
                if os.path.isfile(path_dataset_history + '/data_obj.pickle'):
                    ...
                    with open(path_dataset_history + '/data_obj.pickle', 'wb') as f:
                        pickle.dump(d, f)
                m = LinearThresholdRandomDynamic()
                ...
                new_path_dataset_history[4] = 'linear-threshold-random-dynamic-14all'
