...
class model():
    ...
    def estimateContagionCorrelationMatrix(data):
        ...
        tmp = data.eventsLog[['user', 'contagion']].drop_duplicates(subset=None, keep='first', inplace=False)
    ...
    @staticmethod
    def estimateAdajacencyMatrix(data):
    # TODO Implement


    @staticmethod
    def estimateThresholdsVector(data):
    #TODO Implement
